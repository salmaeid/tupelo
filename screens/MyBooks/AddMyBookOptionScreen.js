...
class AddMyBookOptionScreen extends React.Component {
    ...
    return (
      <View style={styles.container}>
        ...
        <Button
          ...
          color={Colors.tintColor}
          onPress={() =>
            navigation.navigate("MyBooksSearchBookScreen", {
              onSelected: this.onSelected
            })
          }
        />
...
AddMyBookOptionScreen.propTypes = {
  navigation: PropTypes.shape({
    navigate: PropTypes.func.isRequired
  }).isRequired
};

export default AddMyBookOptionScreen;
